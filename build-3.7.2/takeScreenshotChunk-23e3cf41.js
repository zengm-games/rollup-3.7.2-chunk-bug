import { c as GAME_NAME, i as isSport, b as SUBREDDIT_NAME, a0 as TWITTER_HANDLE } from './getCols-55f556d5.js';
import { U as logEvent, bb as fetchWrapper } from './index-fcb3f17e.js';
...
const takeScreenshotChunk = async () => {
  ...
  const logoHTML = logos.length > 0 && logos[0] instanceof HTMLImageElement ? `<img src="${logos[0].src}" width="18" height="18">` : "";
  watermark.innerHTML = `<nav class="navbar navbar-light bg-light rounded-3 px-3"><a class="navbar-brand me-auto" href="#">${logoHTML} ${GAME_NAME}</a><div class="flex-grow-1"></div><span class="navbar-text" style="color: ${theme === "dark" ? "#fff" : "#000"}; font-weight: bold">Play your own league free at ${process.env.SPORT}${!isSport("hockey") ? "-gm" : ".zengm"}.com</span></nav>
	<nav class="navbar navbar-border navbar-light mb-2 px-0"><h1 class="mb-0">${document.title}</nav>`;
...
export { takeScreenshotChunk as default };
